...
Created on Mar 9, 2018
    ...
    This class override PyLDAvis builder to aggregate labels to the final visualization
...
from pyLDAvis._display import prepared_data_to_html, save_html
...
<div id={{ visid }} width="100%" align="center"></div>
...
class MyDisplay(object):
    def prepare(self, lda_model, dtm, vectorizer, mds):
        return pyLDAvis.sklearn.prepare(lda_model, dtm, vectorizer, mds=mds)

    def prepared_data_to_html(self, data, json_names=None, d3_url=None, ldavis_url=None, ldavis_css_url=None,
                          template_type="simple", visid=None, use_http=False):
        ...
        if json_names is None:
            ...
            vis_json=json.loads(data.to_json())
            vis_json['mdsDat']['topic.names']=json_names['topic.names']
            vis_json = json.dumps(vis_json)
    ...
    def save_html(self, data, fileobj, **kwargs):
        ...
        **kwargs :
        ...
        fileobj.write(self.prepared_data_to_html(data, **kwargs))
    
    
    def save_json(self, data, fileobj):
